...
public class PlantaTratadora {
    ...
    public void TratarOrganico(){
        if (Contenedor.getTipoDesecho().equals("Organicos")) {
    ...
    public void TratarPapelesCarton(){
        if (Contenedor.getTipoDesecho().equals("Papeles/Cartones")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    public void TratarVidrios(){
        if (Contenedor.getTipoDesecho().equals("Vidrios")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    public void TratarPlásticos(){
        if (Contenedor.getTipoDesecho().equals("Plásticos")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    public void TratarChatarraMetal(){
        if (Contenedor.getTipoDesecho().equals("Chatarra/Metal")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    public void TratarAceites(){
        if (Contenedor.getTipoDesecho().equals("Aceites")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    public void TratarPinturas(){
        if (Contenedor.getTipoDesecho().equals("Pinturas")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    public void TratarBaterías(){
        if (Contenedor.getTipoDesecho().equals("Baterías")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    public void TratarPilas(){
        if (Contenedor.getTipoDesecho().equals("Pilas")) {
            System.out.println("Tipo del Desecho" + Contenedor.getTipoDesecho());
            System.out.println("Nombre del desecho:" );
    ...
    PlantaTratadora(){
        ...
        switch (Contenedor.getTipoDesecho()){
            ...
            case "Organico": TratarOrganico(); break;
            case "Papeles/Cartones": TratarPapelesCarton(); break;
            case "Vidrios": TratarVidrios(); break;
            case "Plásticos": TratarPlásticos(); break;
            case "Chatarra/Metal": TratarChatarraMetal(); break;
            case "Aceites": TratarAceites(); break;
            case "Pinturas": TratarPinturas(); break;
            case "Baterías": TratarBaterías(); break;
