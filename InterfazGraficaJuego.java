...
public class InterfazGraficaJuego extends JFrame{
    ...
    private ImageIcon congrats = new ImageIcon("Imagenes/Congratulations.jpg");
    ...
    private JPanel apoyoP4 = new JPanel(), apoyoP5 = new JPanel();
    ...
    public void initPaneles(){
        ...
        for (int i=0;i<toolBar.length;i++){
            ...
            toolBar[i].setFont(new Font("Bahnschrift",Font.PLAIN,14));
            bottomBar[i].setFont(new Font("Bahnschrift",Font.PLAIN,14));
        }
        ...
        panelesFondo[1].setBackground(Color.WHITE);
        toolBar[1].setLayout(new BorderLayout());
        toolBar[1].setBorder(new EmptyBorder(30,20,30,20));
        toolBar[1].setBackground(new Color(0xd6d6d6));
        bottomBar[1].setLayout(new BorderLayout());
        bottomBar[1].setBorder(new EmptyBorder(20,20,20,20));
        bottomBar[1].setBackground(new Color(0xd6d6d6));
        panelGlobalBotes.setLayout(new GridBagLayout());
        panelGlobalBotes.setBackground(Color.WHITE);
        pBotesContenedor.setLayout(new GridLayout(3, 6, 10, 10));
        pBotesContenedor.setBackground(Color.white);
        c.gridx = 0; c.gridy = 1;
        ...
        toolBar[2].setBorder(new EmptyBorder(30,20,30,20));
        ...
        panelesFondo[4].setLayout(new GridLayout(4,1));
        panelesFondo[4].setBorder(new EmptyBorder(40,40,40,40));

        panelesFondo[5].setLayout(new GridLayout(3,1));
        panelesFondo[5].setBorder(new EmptyBorder(40,40,40,40));
    ...
    public void initBotonesContenedores(){
        for (int i=0;i<bBotes.length;i++){
            ...
            bBotes[i].setBackground(new Color(0xe6e8c5));
            bBotes[i].setOpaque(true);
    ...
    public void initBotonesProcesos(){
        ...
        for (int i=0;i<bProcesos.length;i++){
            ...
            bProcesos[i].setBackground(new Color(0xe6e8c5));
    ...
    public void initEtiquetas(){
        ...
        lPresentacion.setPreferredSize(new Dimension(400, 150));
    ...
    public void initEtiquetasContenedores(){
        ...
        for(int i=0; i<lBotes.length; i++){
            ...
            lBotes[i].setBackground(new Color(0xf7f2d1));
    ...
    public void initEtiquetasTiempRest(){
        for (int i=0;i<lTiempoRest.length;i++){
            ...
            lTiempoRest[i].setHorizontalAlignment(JLabel.CENTER);
            lTiempoRest[i].setPreferredSize(new Dimension(150,80));
    ...
    public void initEtiquetasDesecho(){
        for (int i=0;i<lDesechos.length;i++){
            ...
            lDesechos[i].setPreferredSize(new Dimension(230,15));
            //lDesechos[i].setLocation((WIDTH-lDesechos[i].getWidth())/2, 600);
            lDesechos[i].setBackground(new Color(0xeadaab));
    ...
    public void initEtiquetasMuestraResultados(){
        ...
        for (int i=0;i<lMuestraTiempoMyrCont.length;i++){
            ...
            lMuestraTiempoMyrCont[i].setSize(40,70);
            lMuestraTiempoMyrCont[i].setFont(new Font("Bahnschrift",Font.PLAIN,14));
        ...
        lMuestraTiempoMyrCont[0].setBorder(new EmptyBorder(10,10,10,10));
        lMuestraTiempoMyrCont[1].setBorder(new EmptyBorder(10,10,0,10));
    }
    ...
    public void initEtiquetasResultFinales(){
        ...
        lPresentResFinal[0].setSize(250,120);
        lPresentResFinal[1].setSize(250,600);
    ...
    public void muestraPanelResultados(){
        if (panelesFondo[5].isAncestorOf(lMuestraTiempoMyrCont[1])) {
            panelesFondo[5].remove(lMuestraTiempoMyrCont[1]);
        }
        ...
        final Object monitor = new Object(); // Objeto de sincronización
        panelesFondo[5].add(lMuestraTiempoMyrCont[1]);
        Timer timerMuestraMyrCont = new Timer(1000, new ActionListener() {
            int tiempoRest = 10;
